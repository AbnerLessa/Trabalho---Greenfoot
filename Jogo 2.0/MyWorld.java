...
public class MyWorld extends World
{
    ...
    public void act(){
        if(ataque < 6){
            this.showText("CUIDADO - Chuva de Meteoros:" + ataque + "Destruidos:" + meteoros,300,620);
        }
        if(totalPedras1 > 0){
        ...
        if(ataque > 5){
            this.showText("Você Perdeu! Os meteoros chegaram a Terra - Destruiu:" + meteoros,300,620);
            Greenfoot.stop();
        }
